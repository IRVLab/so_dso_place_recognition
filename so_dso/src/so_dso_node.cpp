...
#include "output_wrappers/OutputWrapperSODSO.h"
...
private:
  ...
  IOWrap::OutputWrapperSODSO *outputWrapperSODSO;
...
SODSONode::SODSONode() {
  ...
  outputWrapperSODSO = new IOWrap::OutputWrapperSODSO();
  so_dso_System->outputWrapper.push_back(outputWrapperSODSO);
